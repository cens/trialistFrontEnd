...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t6525 && (cljs.core.t6525 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta6526 = g;
    ...
    }, cljs.core.t6525.cljs$lang$type = !0, cljs.core.t6525.cljs$lang$ctorStr = "cljs.core/t6525", cljs.core.t6525.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t6525")
    }, cljs.core.t6525.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t6525.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(c.slice()))
    }, cljs.core.t6525.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t6525.prototype.cljs$core$Fn$ = !0, cljs.core.t6525.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta6526
    }, cljs.core.t6525.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t6525(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t6525 = function(b, c, f, g) {
      return new cljs.core.t6525(b, c, f, g)
    });
    return new cljs.core.t6525(c, b, with_meta, null)
...
var trialist = {net:{}};
trialist.net.edn__GT_params = function(a) {
  return cljs.core.apply.call(null, cljs.core.str, cljs.core.interpose.call(null, "\x26", function() {
    return function c(a) {
      return new cljs.core.LazySeq(null, function() {
        for(;;) {
          ...
          if(e) {
                ...
                for(var a = 0;;) {
                  if(a < g) {
                    ...
                    cljs.core.chunk_append.call(null, h, function() {
                      var a = cljs.core.first.call(null, c), d = cljs.core.second.call(null, c);
                      return[cljs.core.str(cljs.core.name.call(null, a)), cljs.core.str("\x3d"), cljs.core.str(d)].join("")
                    }());
                    a += 1
                  }else {
                    return!0
            ...
            return cljs.core.cons.call(null, function() {
              var a = cljs.core.first.call(null, k), c = cljs.core.second.call(null, k);
              return[cljs.core.str(cljs.core.name.call(null, a)), cljs.core.str("\x3d"), cljs.core.str(c)].join("")
...
trialist.net.POST = function(a, b, c) {
  return goog.net.XhrIo.send(a, function(a) {
    return c.call(null, cljs.core.js__GT_clj.call(null, a.target.getResponseJson(), new cljs.core.Keyword(null, "keywordize-keys", "keywordize-keys", 4191781672), !0))
  }, "POST", trialist.net.edn__GT_params.call(null, b))
};
trialist.net.GET = function(a, b) {
  return goog.net.XhrIo.send(a, b, "GET")
};
var clojure = {string:{}};
...
try {
  ...
  if(e7893 instanceof ReferenceError) {
    var __7894 = e7893;
...
dommy.core.selector_map = function selector_map(b, c) {
  ...
  return cljs.core.merge.call(null, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "container", "container", 602947571), d], !0), cljs.core.into.call(null, cljs.core.PersistentArrayMap.EMPTY, cljs.core.map.call(null, function(e) {
    ...
    return cljs.core.PersistentVector.fromArray([f, cljs.core.truth_((new cljs.core.Keyword(null, "live", "live", 1017226334)).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null, g))) ? function() {
      "undefined" === typeof dommy.core.t7424 && (dommy.core.t7424 = function(b, c, d, e, f, g, q, r, s) {
        this.v = b;
        this.k = c;
        this.vec__7423 = d;
        this.p__7422 = e;
      ...
      }, dommy.core.t7424.cljs$lang$type = !0, dommy.core.t7424.cljs$lang$ctorStr = "dommy.core/t7424", dommy.core.t7424.cljs$lang$ctorPrWriter = function(b, c, d) {
        return cljs.core._write.call(null, c, "dommy.core/t7424")
      }, dommy.core.t7424.prototype.cljs$core$IDeref$_deref$arity$1 = function(b) {
      ...
      }, dommy.core.t7424.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
        return this.meta7425
      }, dommy.core.t7424.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new dommy.core.t7424(this.v, this.k, this.vec__7423, this.p__7422, this.container, this.key_selectors_map, this.template, this.selector_map, c)
      }, dommy.core.__GT_t7424 = function(b, c, d, e, f, g, q, r, s) {
        return new dommy.core.t7424(b, c, d, e, f, g, q, r, s)
      });
      return new dommy.core.t7424(g, f, e, e, d, c, b, selector_map, null)
...
trialist.tmain = {};
trialist.tmain.data = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
trialist.tmain.metadata = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
trialist.tmain.results = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.EMPTY);
trialist.tmain.remove_BANG_ = function(a) {
  a = document.querySelector(dommy.core.selector.call(null, a));
  return cljs.core.truth_(a) ? dommy.core.remove_BANG_.call(null, a) : null
};
trialist.tmain.url = "/app/";
trialist.tmain.client = "preempt-viz";
trialist.tmain.auth_token = goog.net.cookies.get("auth_token");
dommy.core.listen_BANG_.call(null, document.getElementById("choose-patient"), new cljs.core.Keyword(null, "submit", "submit", 4417336202), function(a) {
  a.preventDefault();
  a = document.getElementById("patient");
...
trialist.tmain.signin = function(a, b, c) {
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Signing In...");
  return trialist.net.POST.call(null, [cljs.core.str(trialist.tmain.url), cljs.core.str("user/auth_token")].join(""), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "user", "user", 1017503549), a, new cljs.core.Keyword(null, "password", "password", 2230889997), b, new cljs.core.Keyword(null, "client", "client", 3951159101), trialist.tmain.client], !0), function(b) {
    console.log(cljs.core.pr_str.call(null, b));
    return cljs.core._EQ_.call(null, cljs.core.get.call(null, b, new cljs.core.Keyword(null, "result", "result", 4374444943)), "failure") ? dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), cljs.core.get_in.call(null, b, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "errors", "errors", 4014236381), 0, new cljs.core.Keyword(null, "text", "text", 1017460895)], !0))) : trialist.tmain.load_data.call(null, cljs.core.get.call(null, b, new cljs.core.Keyword(null, "token", 
    "token", 1124445547)), cljs.core.truth_(c) ? c : a)
  })
};
trialist.tmain.load_data = function(a, b) {
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Loading Data...");
  dommy.core.set_text_BANG_.call(null, document.querySelector("#username tspan"), b);
  return trialist.net.POST.call(null, [cljs.core.str(trialist.tmain.url), cljs.core.str("stream/read")].join(""), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "auth_token", "auth_token", 3352104980), a, new cljs.core.Keyword(null, "client", "client", 3951159101), trialist.tmain.client, new cljs.core.Keyword(null, "observer_id", "observer_id", 1139874454), "io.omh.trialist", new cljs.core.Keyword(null, "observer_version", "observer_version", 4705866721), "2013013000", new cljs.core.Keyword(null, 
  "stream_id", "stream_id", 698279340), "data", new cljs.core.Keyword(null, "stream_version", "stream_version", 1145144971), "2013013000", new cljs.core.Keyword(null, "username", "username", 748190792), b, new cljs.core.Keyword(null, "chronological", "chronological", 2808549240), !1], !0), function(c) {
    if(cljs.core._EQ_.call(null, cljs.core.get.call(null, c, new cljs.core.Keyword(null, "result", "result", 4374444943)), "failure")) {
      return dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "errors", "errors", 4014236381), 0, new cljs.core.Keyword(null, "text", "text", 1017460895)], !0)))
    }
    cljs.core.reset_BANG_.call(null, trialist.tmain.data, cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "data", "data", 1016980252), 0, new cljs.core.Keyword(null, "data", "data", 1016980252), new cljs.core.Keyword(null, "data", "data", 1016980252)], !0)));
    console.log(cljs.core.pr_str.call(null, cljs.core.deref.call(null, trialist.tmain.data)));
    cljs.core.reset_BANG_.call(null, trialist.tmain.metadata, cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "data", "data", 1016980252), 0, new cljs.core.Keyword(null, "data", "data", 1016980252), new cljs.core.Keyword(null, "metadata", "metadata", 563900065)], !0)));
    console.log(cljs.core.pr_str.call(null, cljs.core.deref.call(null, trialist.tmain.metadata)));
    return trialist.net.POST.call(null, [cljs.core.str(trialist.tmain.url), cljs.core.str("stream/read")].join(""), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "auth_token", "auth_token", 3352104980), a, new cljs.core.Keyword(null, "client", "client", 3951159101), trialist.tmain.client, new cljs.core.Keyword(null, "observer_id", "observer_id", 1139874454), "io.omh.trialist", new cljs.core.Keyword(null, "observer_version", "observer_version", 4705866721), "2013013000", new cljs.core.Keyword(null, 
    "stream_id", "stream_id", 698279340), "results", new cljs.core.Keyword(null, "stream_version", "stream_version", 1145144971), "2013013000", new cljs.core.Keyword(null, "username", "username", 748190792), b, new cljs.core.Keyword(null, "chronological", "chronological", 2808549240), "false"], !0), function(a) {
      if(cljs.core._EQ_.call(null, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "result", "result", 4374444943)), "failure")) {
        return dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), cljs.core.get_in.call(null, a, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "errors", "errors", 4014236381), 0, new cljs.core.Keyword(null, "text", "text", 1017460895)], !0)))
      }
      cljs.core.reset_BANG_.call(null, trialist.tmain.results, a);
      console.log(cljs.core.pr_str.call(null, cljs.core.deref.call(null, trialist.tmain.results)));
      return trialist.tmain.render.call(null)
    })
  })
};
trialist.tmain.labels = function() {
  dommy.core.set_text_BANG_.call(null, document.querySelector("#treatment-a tspan"), cljs.core.get_in.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "regimen_a", "regimen_a", 1086151285), 0], !0)));
  dommy.core.set_text_BANG_.call(null, document.querySelector("#treatment-b tspan"), cljs.core.get_in.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "regimen_b", "regimen_b", 1086151286), 0], !0)));
  return dommy.core.set_text_BANG_.call(null, document.querySelector("#date tspan"), [cljs.core.str("From: "), cljs.core.str(cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "trial_start_date", "trial_start_date", 2615042470))), cljs.core.str(" To: "), cljs.core.str(cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "trial_end_date", "trial_end_date", 3640598285)))].join(""))
};
trialist.tmain.setup_grid = function() {
  var a = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "number_of_cycles", "number_of_cycles", 2965734833));
  cljs.core._EQ_.call(null, a, 2) ? (trialist.tmain.remove_BANG_.call(null, "#cycles-3"), trialist.tmain.remove_BANG_.call(null, "#cycles-4")) : cljs.core._EQ_.call(null, a, 3) ? (trialist.tmain.remove_BANG_.call(null, "#cycles-2"), trialist.tmain.remove_BANG_.call(null, "#cycles-4")) : cljs.core._EQ_.call(null, a, 4) && (trialist.tmain.remove_BANG_.call(null, "#cycles-2"), trialist.tmain.remove_BANG_.call(null, "#cycles-3"));
  return null
};
trialist.tmain.pairs = function() {
  var a = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "cycle_ab_pairs", "cycle_ab_pairs", 3331865062)), b = clojure.string.split.call(null, a, ""), a = cljs.core.filter.call(null, function(a, b) {
    return function(a) {
      return cljs.core.not_EQ_.call(null, a, ",")
    }
  }(a, b), b);
  return cljs.core.vec.call(null, a)
};
trialist.tmain.ab_pairs = function() {
  for(var a = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "number_of_cycles", "number_of_cycles", 2965734833)), b = trialist.tmain.pairs.call(null), c = cljs.core.seq.call(null, cljs.core.range.call(null, 1, cljs.core.count.call(null, b) + 1)), d = null, e = 0, f = 0;;) {
    if(f < e) {
      var g = cljs.core._nth.call(null, d, f), h = cljs.core.get.call(null, b, g - 1), k = cljs.core._EQ_.call(null, "A", h) ? "#ff0000" : "#000080", g = [cljs.core.str("#c"), cljs.core.str(a), cljs.core.str("-p"), cljs.core.str(g), cljs.core.str(" tspan")].join(""), l = document.querySelector(dommy.core.selector.call(null, g));
      cljs.core.truth_(l) && dommy.core.set_style_BANG_.call(null, dommy.core.set_text_BANG_.call(null, document.querySelector(dommy.core.selector.call(null, g)), h), new cljs.core.Keyword(null, "fill", "fill", 1017047285), k);
      f += 1
    }else {
      if(c = cljs.core.seq.call(null, c)) {
        cljs.core.chunked_seq_QMARK_.call(null, c) ? (g = cljs.core.chunk_first.call(null, c), c = cljs.core.chunk_rest.call(null, c), d = g, e = g = cljs.core.count.call(null, g)) : (g = cljs.core.first.call(null, c), d = cljs.core.get.call(null, b, g - 1), e = cljs.core._EQ_.call(null, "A", d) ? "#ff0000" : "#000080", g = [cljs.core.str("#c"), cljs.core.str(a), cljs.core.str("-p"), cljs.core.str(g), cljs.core.str(" tspan")].join(""), f = document.querySelector(dommy.core.selector.call(null, g)), 
        cljs.core.truth_(f) && dommy.core.set_style_BANG_.call(null, dommy.core.set_text_BANG_.call(null, document.querySelector(dommy.core.selector.call(null, g)), d), new cljs.core.Keyword(null, "fill", "fill", 1017047285), e), c = cljs.core.next.call(null, c), d = null, e = 0), f = 0
      }else {
        return null
      }
    }
...
trialist.tmain.clone_ids = function clone_ids(b) {
  var c = dommy.core.attr.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597));
  cljs.core.truth_(c) && dommy.core.attr_BANG_.call(null, b, new cljs.core.Keyword(null, "id", "id", 1013907597), [cljs.core.str(c), cljs.core.str("-clone")].join(""));
  b = cljs.core.seq.call(null, goog.dom.getChildren(b));
  for(var c = null, d = 0, e = 0;;) {
    if(e < d) {
      var f = cljs.core._nth.call(null, c, e);
      clone_ids.call(null, f);
      e += 1
    }else {
      if(b = cljs.core.seq.call(null, b)) {
        c = b, cljs.core.chunked_seq_QMARK_.call(null, c) ? (b = cljs.core.chunk_first.call(null, c), d = cljs.core.chunk_rest.call(null, c), c = b, f = cljs.core.count.call(null, b), b = d, d = f) : (f = cljs.core.first.call(null, c), clone_ids.call(null, f), b = cljs.core.next.call(null, c), c = null, d = 0), e = 0
      }else {
        return null
      }
    }
...
trialist.tmain.clone_grid = function() {
  var a = document.getElementById("cycles-2"), a = null == a ? document.getElementById("cycles-3") : a, a = (null == a ? document.getElementById("cycles-4") : a).cloneNode(!0);
  dommy.core.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "transform", "transform", 2066570974), "translate(-32.409, 464)");
  return dommy.core.append_BANG_.call(null, document.getElementById("svg"), a)
};
trialist.tmain.x_time = function(a) {
  a = cljs.core.get.call(null, a, new cljs.core.Keyword(null, "timestamp", "timestamp", 1069030536));
  var b = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "trial_start_date", "trial_start_date", 2615042470)), c = Date.parse(b), b = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "trial_end_date", "trial_end_date", 3640598285)), b = Date.parse(b), c = b - c;
  a = Date.parse(a);
  return 260 * (1 - (b - a) / c)
};
trialist.tmain.y_coord = function() {
  var a = null, b = function(a) {
    return 267 * ((10 - a) / 10)
  }, c = function(b, c) {
    var f = cljs.core.get.call(null, b, c);
...
trialist.tmain.before_end_date = function(a) {
  return Date.parse(cljs.core.get.call(null, a, new cljs.core.Keyword(null, "timestamp", "timestamp", 1069030536))) < Date.parse(cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "trial_end_date", "trial_end_date", 3640598285)))
};
trialist.tmain.svg_ns = "http://www.w3.org/2000/svg";
trialist.tmain.svg_node = function(a) {
  document.getElementById("svg");
  return document.createElementNS(trialist.tmain.svg_ns, a)
};
trialist.tmain.get_clr = function(a, b) {
  return cljs.core._EQ_.call(null, a, "A") && cljs.core._EQ_.call(null, b, "A") ? "red" : cljs.core._EQ_.call(null, a, "B") && cljs.core._EQ_.call(null, b, "B") ? "#000080" : cljs.core._EQ_.call(null, a, "A") && cljs.core._EQ_.call(null, b, "B") ? "url(#red-blue)" : cljs.core._EQ_.call(null, a, "B") && cljs.core._EQ_.call(null, b, "A") ? "url(#blue-red)" : null
};
trialist.tmain.graph_1 = function() {
  cljs.core.count.call(null, cljs.core.deref.call(null, trialist.tmain.data));
  var a = trialist.tmain.svg_node.call(null, "g");
  dommy.core.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "id", "id", 1013907597), "graph-1", new cljs.core.Keyword(null, "transform", "transform", 2066570974), "translate(57, 193)");
  for(var b = cljs.core.seq.call(null, cljs.core.range.call(null, 1, cljs.core.count.call(null, cljs.core.deref.call(null, trialist.tmain.data)))), c = null, d = 0, e = 0;;) {
    if(e < d) {
      var f = cljs.core._nth.call(null, c, e), g = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.data), f - 1);
      if(cljs.core.truth_(g)) {
        var f = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.data), f), h = trialist.tmain.svg_node.call(null, "line");
        dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, h, "x1", trialist.tmain.x_time.call(null, g), "y1", trialist.tmain.y_coord.call(null, g, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", trialist.tmain.x_time.call(null, f), "y2", trialist.tmain.y_coord.call(null, f, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", trialist.tmain.get_clr.call(null, 
        cljs.core.get.call(null, g, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)), cljs.core.get.call(null, f, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)))), "stroke-width", 2);
        dommy.core.append_BANG_.call(null, a, h)
      }
      e += 1
    }else {
      if(b = cljs.core.seq.call(null, b)) {
        cljs.core.chunked_seq_QMARK_.call(null, b) ? (d = cljs.core.chunk_first.call(null, b), b = cljs.core.chunk_rest.call(null, b), c = d, d = cljs.core.count.call(null, d)) : (d = cljs.core.first.call(null, b), c = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.data), d - 1), cljs.core.truth_(c) && (d = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.data), d), e = trialist.tmain.svg_node.call(null, "line"), dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, 
        dommy.core.set_attr_BANG_.call(null, e, "x1", trialist.tmain.x_time.call(null, c), "y1", trialist.tmain.y_coord.call(null, c, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", trialist.tmain.x_time.call(null, d), "y2", trialist.tmain.y_coord.call(null, d, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", trialist.tmain.get_clr.call(null, cljs.core.get.call(null, c, new cljs.core.Keyword(null, 
        "regimen", "regimen", 2100011731)), cljs.core.get.call(null, d, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)))), "stroke-width", 2), dommy.core.append_BANG_.call(null, a, e)), b = cljs.core.next.call(null, b), c = null, d = 0), e = 0
      }else {
        break
      }
    }
...
trialist.tmain.graph_2_a = function() {
  var a = cljs.core.vec.call(null, cljs.core.filter.call(null, function(a) {
    return cljs.core._EQ_.call(null, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)), "A")
  }, cljs.core.deref.call(null, trialist.tmain.data))), b = cljs.core.count.call(null, a), c = 135 + 135 / b, d = trialist.tmain.svg_node.call(null, "g");
  dommy.core.set_attr_BANG_.call(null, d, new cljs.core.Keyword(null, "id", "id", 1013907597), "graph-2-a", new cljs.core.Keyword(null, "transform", "transform", 2066570974), "translate(421, 193)");
  for(var e = cljs.core.seq.call(null, cljs.core.range.call(null, 1, cljs.core.count.call(null, a))), f = null, g = 0, h = 0;;) {
    if(h < g) {
      var k = cljs.core._nth.call(null, f, h), l = cljs.core.get.call(null, a, k - 1);
      if(cljs.core.truth_(l)) {
        var m = cljs.core.get.call(null, a, k), n = trialist.tmain.svg_node.call(null, "line");
        dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, n, "x1", c * ((k - 1) / b), "y1", trialist.tmain.y_coord.call(null, l, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", c * (k / b), "y2", trialist.tmain.y_coord.call(null, m, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", "red"), "stroke-width", 2);
        dommy.core.append_BANG_.call(null, d, n)
      }
      h += 1
    }else {
      if(e = cljs.core.seq.call(null, e)) {
        cljs.core.chunked_seq_QMARK_.call(null, e) ? (g = cljs.core.chunk_first.call(null, e), e = cljs.core.chunk_rest.call(null, e), f = g, g = cljs.core.count.call(null, g)) : (f = cljs.core.first.call(null, e), g = cljs.core.get.call(null, a, f - 1), cljs.core.truth_(g) && (h = cljs.core.get.call(null, a, f), k = trialist.tmain.svg_node.call(null, "line"), dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, k, "x1", c * ((f - 1) / b), 
        "y1", trialist.tmain.y_coord.call(null, g, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", c * (f / b), "y2", trialist.tmain.y_coord.call(null, h, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", "red"), "stroke-width", 2), dommy.core.append_BANG_.call(null, d, k)), e = cljs.core.next.call(null, e), f = null, g = 0), h = 0
      }else {
        break
      }
    }
...
trialist.tmain.graph_2_b = function() {
  var a = cljs.core.vec.call(null, cljs.core.filter.call(null, function(a) {
    return cljs.core._EQ_.call(null, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)), "B")
  }, cljs.core.deref.call(null, trialist.tmain.data))), b = cljs.core.count.call(null, a), c = 135 + 135 / b, d = trialist.tmain.svg_node.call(null, "g");
  dommy.core.set_attr_BANG_.call(null, d, new cljs.core.Keyword(null, "id", "id", 1013907597), "graph-2-b", new cljs.core.Keyword(null, "transform", "transform", 2066570974), "translate(556, 193)");
  for(var e = cljs.core.seq.call(null, cljs.core.range.call(null, 1, cljs.core.count.call(null, a))), f = null, g = 0, h = 0;;) {
    if(h < g) {
      var k = cljs.core._nth.call(null, f, h), l = cljs.core.get.call(null, a, k - 1);
      if(cljs.core.truth_(l)) {
        var m = cljs.core.get.call(null, a, k), n = trialist.tmain.svg_node.call(null, "line");
        dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, n, "x1", c * ((k - 1) / b), "y1", trialist.tmain.y_coord.call(null, l, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", c * (k / b), "y2", trialist.tmain.y_coord.call(null, m, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", "#000080"), "stroke-width", 2);
        dommy.core.append_BANG_.call(null, d, n)
      }
      h += 1
    }else {
      if(e = cljs.core.seq.call(null, e)) {
        cljs.core.chunked_seq_QMARK_.call(null, e) ? (g = cljs.core.chunk_first.call(null, e), e = cljs.core.chunk_rest.call(null, e), f = g, g = cljs.core.count.call(null, g)) : (f = cljs.core.first.call(null, e), g = cljs.core.get.call(null, a, f - 1), cljs.core.truth_(g) && (h = cljs.core.get.call(null, a, f), k = trialist.tmain.svg_node.call(null, "line"), dommy.core.set_style_BANG_.call(null, dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, k, "x1", c * ((f - 1) / b), 
        "y1", trialist.tmain.y_coord.call(null, g, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826)), "x2", c * (f / b), "y2", trialist.tmain.y_coord.call(null, h, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))), "stroke", "#000080"), "stroke-width", 2), dommy.core.append_BANG_.call(null, d, k)), e = cljs.core.next.call(null, e), f = null, g = 0), h = 0
      }else {
        break
      }
    }
...
trialist.tmain.ave = function(a, b) {
  var c = cljs.core.filter.call(null, function(a) {
    return cljs.core._EQ_.call(null, b, cljs.core.get.call(null, a, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731)))
  }, cljs.core.deref.call(null, trialist.tmain.data)), c = cljs.core.map.call(null, function(b) {
    return function(b) {
      return cljs.core.get.call(null, b, a)
    }
  }(c), c), c = cljs.core.reduce.call(null, cljs.core._PLUS_, c) / cljs.core.count.call(null, c), d = cljs.core.get.call(null, trialist.tmain.conversion_rates, a), d = cljs.core.truth_(d) ? d : 1;
  return cljs.core.fn_QMARK_.call(null, d) ? d.call(null, c) : d * c
};
trialist.tmain.rnd_ave = function(a, b) {
  return Math.round(trialist.tmain.ave.call(null, a, b))
};
trialist.tmain.pain_ave = function(a, b) {
  var c = cljs.core.filter.call(null, function(c) {
    return cljs.core._EQ_.call(null, a, cljs.core.get.call(null, c, new cljs.core.Keyword(null, "regimen", "regimen", 2100011731))) && cljs.core._EQ_.call(null, b, cljs.core.get.call(null, c, new cljs.core.Keyword(null, "cycle", "cycle", 1109036120)))
  }, cljs.core.deref.call(null, trialist.tmain.data)), c = cljs.core.map.call(null, function(a) {
    return function(a) {
      return cljs.core.get.call(null, a, new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826))
    }
  }(c), c);
  return cljs.core.reduce.call(null, cljs.core._PLUS_, c) / cljs.core.count.call(null, c)
};
trialist.tmain.pain_aves = function(a) {
  return cljs.core._EQ_.call(null, a, 1) ? cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "A1", "A1", 1013906306), trialist.tmain.pain_ave.call(null, "A", 1), new cljs.core.Keyword(null, "B1", "B1", 1013906337), trialist.tmain.pain_ave.call(null, "B", 1)], !0) : cljs.core._EQ_.call(null, a, 2) ? cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "A1", "A1", 1013906306), trialist.tmain.pain_ave.call(null, "A", 1), new cljs.core.Keyword(null, "B1", "B1", 1013906337), 
  trialist.tmain.pain_ave.call(null, "B", 1), new cljs.core.Keyword(null, "A2", "A2", 1013906307), trialist.tmain.pain_ave.call(null, "A", 2), new cljs.core.Keyword(null, "B2", "B2", 1013906338), trialist.tmain.pain_ave.call(null, "B", 2)], !0) : cljs.core._EQ_.call(null, a, 3) ? cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "A1", "A1", 1013906306), trialist.tmain.pain_ave.call(null, "A", 1), new cljs.core.Keyword(null, "B1", "B1", 1013906337), trialist.tmain.pain_ave.call(null, 
  "B", 1), new cljs.core.Keyword(null, "A2", "A2", 1013906307), trialist.tmain.pain_ave.call(null, "A", 2), new cljs.core.Keyword(null, "B2", "B2", 1013906338), trialist.tmain.pain_ave.call(null, "B", 2), new cljs.core.Keyword(null, "A3", "A3", 1013906308), trialist.tmain.pain_ave.call(null, "A", 3), new cljs.core.Keyword(null, "B3", "B3", 1013906339), trialist.tmain.pain_ave.call(null, "B", 3)], !0) : cljs.core._EQ_.call(null, a, 4) ? cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, 
  "A1", "A1", 1013906306), trialist.tmain.pain_ave.call(null, "A", 1), new cljs.core.Keyword(null, "B1", "B1", 1013906337), trialist.tmain.pain_ave.call(null, "B", 1), new cljs.core.Keyword(null, "A2", "A2", 1013906307), trialist.tmain.pain_ave.call(null, "A", 2), new cljs.core.Keyword(null, "B2", "B2", 1013906338), trialist.tmain.pain_ave.call(null, "B", 2), new cljs.core.Keyword(null, "A3", "A3", 1013906308), trialist.tmain.pain_ave.call(null, "A", 3), new cljs.core.Keyword(null, "B3", "B3", 1013906339), 
  trialist.tmain.pain_ave.call(null, "B", 3), new cljs.core.Keyword(null, "A4", "A4", 1013906309), trialist.tmain.pain_ave.call(null, "A", 4), new cljs.core.Keyword(null, "B4", "B4", 1013906340), trialist.tmain.pain_ave.call(null, "B", 4)], !0) : null
};
trialist.tmain.graph_3 = function() {
  console.log("graph 3");
  var a = trialist.tmain.pairs.call(null), b = cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "number_of_cycles", "number_of_cycles", 2965734833)), c = trialist.tmain.pain_aves.call(null, b), b = 270 / (2 * b), d = trialist.tmain.svg_node.call(null, "g");
  console.log("w", b);
  dommy.core.set_attr_BANG_.call(null, d, new cljs.core.Keyword(null, "id", "id", 1013907597), "graph-3", new cljs.core.Keyword(null, "transform", "transform", 2066570974), "translate(58,586)");
  for(var e = cljs.core.seq.call(null, cljs.core.range.call(null, 0, cljs.core.count.call(null, a))), f = null, g = 0, h = 0;;) {
    if(h < g) {
      var k = cljs.core._nth.call(null, f, h), l = cljs.core.get.call(null, a, k), m = cljs.core.take.call(null, k, a), m = cljs.core.filter.call(null, cljs.core.PersistentHashSet.fromArray([l, null], !0), m), m = cljs.core.count.call(null, m), m = cljs.core.keyword.call(null, [cljs.core.str(l), cljs.core.str(m + 1)].join("")), n = trialist.tmain.svg_node.call(null, "rect");
      cljs.core.truth_(n) && (dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, n, new cljs.core.Keyword(null, "x", "x", 1013904362), b * k, new cljs.core.Keyword(null, "y", "y", 1013904363), trialist.tmain.y_coord.call(null, cljs.core.get.call(null, c, m)), new cljs.core.Keyword(null, "width", "width", 1127031096), b, new cljs.core.Keyword(null, "height", "height", 4087841945), 3), new cljs.core.Keyword(null, "fill", "fill", 1017047285), cljs.core._EQ_.call(null, l, "A") ? 
      "red" : "#000080"), dommy.core.append_BANG_.call(null, d, n));
      h += 1
    }else {
      if(e = cljs.core.seq.call(null, e)) {
        cljs.core.chunked_seq_QMARK_.call(null, e) ? (g = cljs.core.chunk_first.call(null, e), e = cljs.core.chunk_rest.call(null, e), f = g, g = cljs.core.count.call(null, g)) : (f = cljs.core.first.call(null, e), g = cljs.core.get.call(null, a, f), h = cljs.core.take.call(null, f, a), h = cljs.core.filter.call(null, cljs.core.PersistentHashSet.fromArray([g, null], !0), h), h = cljs.core.count.call(null, h), h = cljs.core.keyword.call(null, [cljs.core.str(g), cljs.core.str(h + 1)].join("")), k = 
        trialist.tmain.svg_node.call(null, "rect"), cljs.core.truth_(k) && (dommy.core.set_style_BANG_.call(null, dommy.core.set_attr_BANG_.call(null, k, new cljs.core.Keyword(null, "x", "x", 1013904362), b * f, new cljs.core.Keyword(null, "y", "y", 1013904363), trialist.tmain.y_coord.call(null, cljs.core.get.call(null, c, h)), new cljs.core.Keyword(null, "width", "width", 1127031096), b, new cljs.core.Keyword(null, "height", "height", 4087841945), 3), new cljs.core.Keyword(null, "fill", "fill", 
        1017047285), cljs.core._EQ_.call(null, g, "A") ? "red" : "#000080"), dommy.core.append_BANG_.call(null, d, k)), e = cljs.core.next.call(null, e), f = null, g = 0), h = 0
      }else {
        break
      }
    }
...
trialist.tmain.bars = function(a, b) {
  var c = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-a")].join(""))), d = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-b")].join(""))), e = trialist.tmain.ave.call(null, b, "A") / 10, f = trialist.tmain.ave.call(null, b, "B") / 10;
  dommy.core.set_attr_BANG_.call(null, c, new cljs.core.Keyword(null, "height", "height", 4087841945), 270 * e);
  dommy.core.set_attr_BANG_.call(null, d, new cljs.core.Keyword(null, "height", "height", 4087841945), 270 * f);
  return e < f ? dommy.core.set_style_BANG_.call(null, c, new cljs.core.Keyword(null, "stroke-width", "stroke-width", 3636011363), 2) : dommy.core.set_style_BANG_.call(null, d, new cljs.core.Keyword(null, "stroke-width", "stroke-width", 3636011363), 2)
};
...
trialist.tmain.graph_4 = function() {
  trialist.tmain.bars.call(null, "pain", new cljs.core.Keyword(null, "averagePainIntensity", "averagePainIntensity", 4636639826));
  trialist.tmain.bars.call(null, "fatigue", new cljs.core.Keyword(null, "fatiguePrompt", "fatiguePrompt", 1744398973));
  trialist.tmain.bars.call(null, "drowsiness", new cljs.core.Keyword(null, "drowsinessPrompt", "drowsinessPrompt", 619474649));
  trialist.tmain.bars.call(null, "sleep", new cljs.core.Keyword(null, "sleepDisturbancePrompt", "sleepDisturbancePrompt", 2006915117));
  trialist.tmain.bars.call(null, "thinking", cljs.core.keyword.call(null, cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "cognitiveFunctionPromptKey", "cognitiveFunctionPromptKey", 3975622299))));
  trialist.tmain.bars.call(null, "const", new cljs.core.Keyword(null, "constipationPrompt", "constipationPrompt", 1329778209));
  return cljs.core.truth_(cljs.core.get_in.call(null, cljs.core.deref.call(null, trialist.tmain.data), cljs.core.PersistentVector.fromArray([0, new cljs.core.Keyword(null, "painHotness", "painHotness", 4427389920)], !0))) ? trialist.tmain.bars.call(null, "np-pain", new cljs.core.Keyword(null, "painHotness", "painHotness", 4427389920)) : trialist.tmain.remove_neuro.call(null)
};
trialist.tmain.confidence = function(a) {
  var b = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-median")].join(""))), c = cljs.core.get_in.call(null, cljs.core.deref.call(null, trialist.tmain.results), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "data", "data", 1016980252), 0, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.keyword.call(null, a)], !0)), d = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, 
  "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "median_effect", "median_effect", 1393180120), 0], !0)), e = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "more_effective_regimen", "more_effective_regimen", 2219619793), 0], !0)), d = 248 * d, e = cljs.core._EQ_.call(null, e, "A") ? -1 * d : d;
  a = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-confidence")].join("")));
  var d = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "upper_bound", "upper_bound", 957966099), 0], !0)), f = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "lower_bound", "lower_bound", 4674860594), 0], !0)), g = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, 
  "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "lower_bound_regimen", "lower_bound_regimen", 3999419476), 0], !0)), c = cljs.core.get_in.call(null, c, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "graph_5", "graph_5", 1294247158), new cljs.core.Keyword(null, "upper_bound_regimen", "upper_bound_regimen", 3108801589), 0], !0)), f = 257 * f, g = cljs.core._EQ_.call(null, g, "A") ? -1 * f : f, d = 257 * d, c = cljs.core._EQ_.call(null, c, "A") ? -1 * d : d, c = 
  [cljs.core.str("M "), cljs.core.str(g), cljs.core.str(",0 "), cljs.core.str(c), cljs.core.str(",0")].join("");
  return cljs.core.truth_(b) ? (dommy.core.set_attr_BANG_.call(null, b, new cljs.core.Keyword(null, "transform", "transform", 2066570974), [cljs.core.str("translate("), cljs.core.str(e), cljs.core.str(", -1)")].join("")), dommy.core.set_attr_BANG_.call(null, a, new cljs.core.Keyword(null, "d", "d", 1013904342), c)) : null
};
trialist.tmain.graph_5 = function() {
  trialist.tmain.confidence.call(null, "pain");
  trialist.tmain.confidence.call(null, "fatigue");
  trialist.tmain.confidence.call(null, "neuropathic_pain");
  trialist.tmain.confidence.call(null, "thinking_problems");
  trialist.tmain.confidence.call(null, "drowsiness");
  trialist.tmain.confidence.call(null, "constipation");
  return trialist.tmain.confidence.call(null, "sleep_problems")
};
trialist.tmain.summary = function(a) {
  var b = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-ac")].join(""))), c = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-am")].join(""))), d = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-as")].join(""))), e = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), 
  cljs.core.str(a), cljs.core.str("-summary-nd")].join(""))), f = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-bs")].join(""))), g = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-bm")].join(""))), h = document.querySelector(dommy.core.selector.call(null, [cljs.core.str("#"), cljs.core.str(a), cljs.core.str("-summary-bc")].join(""))), k = cljs.core.get_in.call(null, 
  cljs.core.deref.call(null, trialist.tmain.results), cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "data", "data", 1016980252), 0, new cljs.core.Keyword(null, "data", "data", 1016980252), cljs.core.keyword.call(null, a), new cljs.core.Keyword(null, "graph_6", "graph_6", 1294247159)], !0));
  a = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "a_better_large", "a_better_large", 4684405436), 0], !0));
  a = 494 * parseFloat(a);
  var l = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "a_better_modest", "a_better_modest", 3171431559), 0], !0)), l = 494 * parseFloat(l), m = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "a_better_small", "a_better_small", 4691211400), 0], !0)), m = 494 * parseFloat(m), n = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "indistinguishable", "indistinguishable", 
  1160854764), 0], !0)), n = 494 * parseFloat(n), p = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "b_better_small", "b_better_small", 4185652775), 0], !0)), p = 494 * parseFloat(p), q = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, "b_better_modest", "b_better_modest", 4678983368), 0], !0)), q = 494 * parseFloat(q), k = cljs.core.get_in.call(null, k, cljs.core.PersistentVector.fromArray([new cljs.core.Keyword(null, 
  "b_better_large", "b_better_large", 4178846811), 0], !0)), k = 494 * parseFloat(k);
  return cljs.core.truth_(d) && cljs.core.truth_(b) ? (dommy.core.set_attr_BANG_.call(null, b, new cljs.core.Keyword(null, "width", "width", 1127031096), a), dommy.core.set_attr_BANG_.call(null, c, new cljs.core.Keyword(null, "x", "x", 1013904362), a, new cljs.core.Keyword(null, "width", "width", 1127031096), l), dommy.core.set_attr_BANG_.call(null, d, new cljs.core.Keyword(null, "x", "x", 1013904362), a + l, new cljs.core.Keyword(null, "width", "width", 1127031096), m), dommy.core.set_attr_BANG_.call(null, 
  e, new cljs.core.Keyword(null, "x", "x", 1013904362), a + l + m, new cljs.core.Keyword(null, "width", "width", 1127031096), n), dommy.core.set_attr_BANG_.call(null, f, new cljs.core.Keyword(null, "x", "x", 1013904362), a + l + m + n, new cljs.core.Keyword(null, "width", "width", 1127031096), p), dommy.core.set_attr_BANG_.call(null, g, new cljs.core.Keyword(null, "x", "x", 1013904362), a + l + m + n + p, new cljs.core.Keyword(null, "width", "width", 1127031096), q), dommy.core.set_attr_BANG_.call(null, 
  h, new cljs.core.Keyword(null, "x", "x", 1013904362), a + l + m + n + p + q, new cljs.core.Keyword(null, "width", "width", 1127031096), k)) : null
};
trialist.tmain.graph_6 = function() {
  trialist.tmain.summary.call(null, "pain");
  trialist.tmain.summary.call(null, "fatigue");
  trialist.tmain.summary.call(null, "thinking_problems");
  trialist.tmain.summary.call(null, "drowsiness");
  trialist.tmain.summary.call(null, "constipation");
...
trialist.tmain.render = function() {
  ...
  trialist.tmain.setup_grid.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Grids...");
  trialist.tmain.ab_pairs.call(null);
  trialist.tmain.clone_grid.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 1...");
  trialist.tmain.graph_1.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 2...");
  trialist.tmain.graph_2_a.call(null);
  trialist.tmain.graph_2_b.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 3...");
  trialist.tmain.graph_3.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 4...");
  trialist.tmain.graph_4.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 5...");
  trialist.tmain.graph_5.call(null);
  dommy.core.set_text_BANG_.call(null, document.getElementById("msg"), "Rendering Graph 6...");
...
trialist.tmain.text = function() {
  ...
  cljs.core.str(trialist.tmain.rnd_ave.call(null, cljs.core.keyword.call(null, cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "cognitiveFunctionPromptKey", "cognitiveFunctionPromptKey", 3975622299))), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, cljs.core.keyword.call(null, cljs.core.get.call(null, cljs.core.deref.call(null, trialist.tmain.metadata), new cljs.core.Keyword(null, "cognitiveFunctionPromptKey", 
  "cognitiveFunctionPromptKey", 3975622299))), "B")), cljs.core.str("/10\n\nConstipation: -------------------------------------- "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "constipationPrompt", "constipationPrompt", 1329778209), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "constipationPrompt", "constipationPrompt", 1329778209), "B")), cljs.core.str("/10\n\nFatigue: ------------------------------------------- "), 
  cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "fatiguePrompt", "fatiguePrompt", 1744398973), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "fatiguePrompt", "fatiguePrompt", 1744398973), "B")), cljs.core.str("/10\n\nDrowsiness: ---------------------------------------- "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "drowsinessPrompt", "drowsinessPrompt", 619474649), "A")), cljs.core.str("/10 "), 
  cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "drowsinessPrompt", "drowsinessPrompt", 619474649), "B")), cljs.core.str("/10\n\n_________________________________________________________________\n\nINTERFERENCE WITH ACTIVITIES OF DAILY LIVING\n\n**Scored 0-10 (lower scores denote better outcomes)**\n\n*Treatment* ---------------------------------------- *A*  *B*\n\nSleeping: ------------------------------------------ "), 
  cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "sleepDisturbancePrompt", "sleepDisturbancePrompt", 2006915117), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "sleepDisturbancePrompt", "sleepDisturbancePrompt", 2006915117), "B")), cljs.core.str("/10\n\nInterference with enjoyment of life (E): ----------- "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "enjoymentOfLife", "enjoymentOfLife", 
  3751138478), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "enjoymentOfLife", "enjoymentOfLife", 3751138478), "B")), cljs.core.str("/10\n\nInterference with general activity (G): ------------ "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "generalActivity", "generalActivity", 4585089929), "A")), cljs.core.str("/10 "), cljs.core.str(trialist.tmain.rnd_ave.call(null, new cljs.core.Keyword(null, "generalActivity", 
  "generalActivity", 4585089929), "B")), cljs.core.str("/10\n_________________________________________________________________\n\n*SERIAL PEG SCORES \u2013 PEG is a 3-item Scale that assesses average\n pain intensity (P), interference with enjoyment of life (E),\n and interference with general activity (G). Lower scores denote\n better outcomes.*")].join(""))
};
